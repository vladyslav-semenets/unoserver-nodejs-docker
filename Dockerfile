...
LABEL org.opencontainers.image.title="unoserver-nodejs-docker"
LABEL org.opencontainers.image.description="Custom Docker Image that contains Unoserver, Node.js 16, and LibreOffice and major set of fonts for file format conversions"
